    ...
    agent any 
        stages { 
            ...
            stage ('deploting the war file ') {
                steps {
                    sh 'scp -r /home/ec2-user/.m2/repository/com/efsavage/hello-world-war/1.0.0/hello-world-war-1.0.0.war ec2-user@172.31.4.208:/home/ec2-user/tomcat/apache-tomcat-8.5.75/webapps/'
